<div class="bg-gray-100 py-10">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold my-5">Search Vacancies</h2>
            ...
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="text"
                        wire:model="word"
                        placeholder="Search by word ej. Laravel"
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">salary</label>
